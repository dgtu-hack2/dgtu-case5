...
angular.module("uib/template/datepicker/day.html", []).run(["$templateCache", function ($templateCache) {
    $templateCache.put("uib/template/datepicker/day.html",
        ...
        "    <tr>\n" +
        "      <th>\n" +
        "        <button type=\"button\" class=\"btn btn-light btn-sm float-left uib-left\" ng-click=\"move(-1)\" tabindex=\"-1\">\n" +
        ...
        "      <th>\n" +
        "        <button type=\"button\" class=\"btn btn-light btn-sm float-right uib-right\" ng-click=\"move(1)\" tabindex=\"-1\">\n" +
        "          <i aria-hidden=\"true\" class=\"fa-svg-icon\">\n" +
...
angular.module("uib/template/datepicker/year.html", []).run(["$templateCache", function ($templateCache) {
    $templateCache.put("uib/template/datepicker/year.html",
        ...
        "              class=\"btn btn-light btn-sm uib-title\" ng-click=\"toggleMode()\"\n" +
